...
* Mean number of imputed steps per day: **`r format(mean(steps_day_impute$steps_per_day,na.rm=TRUE),digits=1) `**
* Median number of imputed steps per day: **`r format(median(steps_day_impute$steps_per_day,na.rm=TRUE),digits=1) `**
...
* Impact to Median from: **`r format(median(steps_day$steps_per_day,na.rm=TRUE)-median(steps_day_impute$steps_per_day,na.rm=TRUE),digits=1) `**
...
# ggplot with day group as facets (panels)
qplot(data=steps_interval_impute,x=interval,y=avg_per_interval,facets="daygroup~.",geom="line")
```
